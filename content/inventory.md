...
### 23. Calculation Rule — Hitung Berapa Available Qty
...
### 24. Check Rule — Aksi Kalau Qty Tidak Cukup
...
### 25. Available Qty Rule Allocation — Assign Rule ke Organisasi
...
### 45. Return to Inventory (Lend & Return Receipt)
...
### 47. Real time Stock Checking

### 48. On-Hand stock Query (现存量查询) (SERING DIPAKAI)
...
### 50. Storage Bin Stock Qty Query (货位存量查询)
...
### 51. Inventory Ledger (SERING DIPAKAI)
...
### 54. Stock Analysis Details (存量分析明细)
...
### 55. Transactions List/History

### 56. Issue/Receipt Query (New) (出入库查询) (SERING DIPAKAI)
...
### 58. Goods Receipt/Issue/Inv Summary (收发存汇总)
...
### 60. Inventory Expectation/Outlook (库存展望)
...
### 61. Inventory Expectation Detail (库存展望明细)
